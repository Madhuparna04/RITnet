...
from dv_bwperim import bwperim
from dv_ellipses import LSqEllipse #The code is pulled frm https://github.com/bdhammel/least-squares-ellipse-fitting
from skimage.draw import ellipse_perimeter
import time         # RAhul Debug
...
def fit_ellipse(img, threshold = 0.75, color = "r", mask=None):
